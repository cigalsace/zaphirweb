...
var app = {
    ...
    template: 'modal.html'   // Template de présentationd e la fiche de métadonnées
};

// Lien vers le serveur de récupération des flux (pb de cross domain)
// var server_url = '../server/index.py';  // "false" pour un accès directe à la page sans passer par le script serveur si l'application cswReader est hébergée sur le serveur du flux CSW.
var server_url = false;  // "false" pour un accès directe à la page sans passer par le script serveur si l'application cswReader est hébergée sur le serveur du flux CSW.
